...
const io = new Server(server, {
  cors: {
      origin: ['http://localhost:3000', 'http://localhost:3002', 'exp://192.168.1.6:8081', 'http://192.168.1.6:8081'],
      credentials: true
  }
})
...
app.use(cors({credentials: true, origin: ['http://localhost:3000', 'http://localhost:3002', 'exp://192.168.1.6:8081', 'http://192.168.1.6:8081'],}));
